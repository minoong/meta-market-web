...
import reduce from '~/utils/lmw/reduce'
import Awaited from '~/utils/lmw/types/Awaited'
import ReturnPipeType from '~/utils/lmw/types/ReturnPipeType'
...
function pipe<T1, T2, R>(a: T1, f1: (a: Awaited<T1>) => T2, f2: (a: Awaited<T2>) => R): ReturnPipeType<[T1, T2, R]>
