...
import { isAsyncIterable, isIterable, isPromise } from '~/utils/lmw/_internal/utils'
...
function asyncSequential<A>(a: Promise<A>, iterable: AsyncIterable<A>): AsyncIterableIterator<A> {
...
function async<A>(a: Promise<A>, iterable: AsyncIterable<A>): AsyncIterableIterator<A> {
...
function append<A>(a: A | Promise<A>, iterable: AsyncIterable<A>): AsyncIterableIterator<A>

function append<A, B extends Iterable<A> | AsyncIterable<A>>(
 a: A,
 iterable?: Iterable<A> | AsyncIterable<A>,
): IterableIterator<A> | AsyncIterableIterator<A> | ((iterable: B) => ReturnIterableIteratorType<B, A>) {
 if (iterable === undefined) {
  return (iterable: B) => append(a, iterable as any) as ReturnIterableIteratorType<B, A>
 }
